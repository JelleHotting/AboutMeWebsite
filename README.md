...
**3D Modellen Manipuleren**
* Ik wil verder leren hoe je 3D modellen in HTML manipuleert door middel van knoppen en animaties. Dit omdat ik al ervaring heb met 3D modellen maar nog niet voldoende genoeg - zo kon ik het wel inladen maar wist ik nog niks ermee te doen.

**CSS Animaties & Keyframes**
* Ik wil meer leren over CSS animaties en keyframes. Ik heb hier voorgaand wel al mee gewerkt maar wil hier dieper op ingaan met complexere animaties.

**CSS Variabelen**
* Ik wil gebruik maken van CSS variabelen, dit omdat ik hierdoor makkelijker kleuren, fonts etc. kan aanpassen indien nodig.
